...
with app.app_context():
    ...
    blogposts_data = [
        {"name": "la fashion", "description": "gives the wild"},
        ...
        {"name": "Beauty secrets", "description": "Open a door to vast knowledge in sin care"},
        {"name": "  Hiking Diary", "description": "Discover the world's best hiking grounds"},
        {"name": "Analog blog", "description": "Travel back to reminiscence ancient cultures"},
        {"name": "ChocolateFanatic", "description": "chocolate discovery "},
        {"name": "Seaman tales", "description": "under water chronicles"},
    ...
    for user in users:
        for _ in range(random.randint(1, 3)):
            ...
            user_blogpost = User_blogposts(user_id=user.id, blogpost_id=blogpost.id, strength=strength)
